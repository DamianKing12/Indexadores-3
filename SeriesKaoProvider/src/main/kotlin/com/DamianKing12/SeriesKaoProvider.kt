...
class SeriesKaoProvider : MainAPI() {
    ...
    override suspend fun loadLinks(
        ...
        // 2. Extracción de IFRAMES (Enlaces externos)
        ...
        // 3. Extracción de Servidores desde bloque JSON 'var servers ='
        ...
        if (scriptElement != null) {
            ...
            try {
                ...
                // Silenciamos errores de parseo para que no detengan la carga de otros links
            }
        }
